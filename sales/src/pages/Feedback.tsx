          ...
          <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5 space-y-4">
            ...
            <div className="flex gap-3">
              <button
                type="submit"
                disabled={submitting}
                className="flex-1 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg disabled:opacity-50 transition-colors"
              >
            ...
            return (
              <div key={item.id} className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
                <div className="flex items-start gap-3">
                  {/* Vote buttons — only on unanswered */}
                  {!isAnswered ? (
                    <div className="flex flex-col gap-1.5 flex-shrink-0 pt-0.5">
                      ...
                      >
                        <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 4l8 8H4l8-8z" /></svg>
                      ...
                      >
                        <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 20l-8-8h16l-8 8z" /></svg>
                        <span className="text-xs font-semibold">{item.downvotes}</span>
                      </button>
                    </div>
                  ) : (
                    <div className="flex flex-col gap-1.5 flex-shrink-0 pt-0.5 opacity-40">
