...
export default function AddClient() {
  ...
  const handleSlug = (val: string) =>
    setForm({ ...form, businessSlug: val.toLowerCase().replace(/[\s-]/g, '_').replace(/[^a-z0-9_]/g, '') });
    ...
    <Layout>
      <div className="max-w-3xl space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold text-gray-900 dark:text-white">Add Client</h1>
            <p className="text-sm text-gray-400 dark:text-gray-500 mt-0.5">Submit a new business lead to TapLab</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-5 pt-2 border-t border-gray-100 dark:border-gray-800">
              <div>
