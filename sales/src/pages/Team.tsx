        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {!data ? (
            ...
            <button
              ...
              className="flex items-center gap-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl px-4 py-4 hover:border-blue-300 dark:hover:border-blue-700 transition-colors text-left w-full"
            >
